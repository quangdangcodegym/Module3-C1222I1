                           ...
                           <div class="col-6">
                               ...
                               <form class="form-horizontal" method="post">
                                   <div class="form-group row">
                                       ...
                                       <div class="col-md-10">
                                           <input name="txtName" type="text" class="form-control" value="${requestScope.customer.getName()}">
                                       </div>
                                   </div>
                                   <div class="form-group row">
                                       <label class="col-md-2 control-label" for="example-email">Email</label>
                                       <div class="col-md-10">
                                           <input type="email" name="txtEmail"  value="${requestScope.customer.getEmail()}" id="example-email" name="example-email" class="form-control" >
                                       </div>
                                   </div>
                                   <div class="form-group row">
                                       <label class="col-md-2 control-label">Address</label>
                                       <div class="col-md-10">
                                           <input type="text" name="txtAddress" value="${requestScope.customer.getAddress()}" class="form-control">
                                       </div>
                                   </div>
                                   ...
                                   <div class="form-group row">
                                       ...
                                       <div class="col-md-10">
                                           <input type="text" class="form-control" value="${requestScope.customer.getImage()}"  name="txtImage">
                                       </div>
                                   </div>
                                   <div class="form-group row">
